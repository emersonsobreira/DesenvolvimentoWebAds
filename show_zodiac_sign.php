...
<div class="container mt-5">
    ...
    foreach ($signos->signo as $signo) {
        ...
        if ($data_nascimento >= $data_inicio && $data_nascimento <= $data_fim) {
            echo "<div class='signo-resultado'>";
            echo "<div class='signo-icon'>🌌</div>";
    ...
    if (!$signo_encontrado) {
        echo "<p class='error-message'>Não foi possível determinar seu signo. Verifique a data informada.</p>";
    }
    ?>
